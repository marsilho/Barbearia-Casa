<section class="duvidas">
    ...
    <form action="{{ route('duvidas.enviar') }}" method="POST" class="form-duvidas">
        ...
        <div class="linha">
            ...
            <input type="email" name="email_contato" placeholder="E-mail:" required>
        </div>

        <div class="linha">
            <input type="text" name="telefone_contato" placeholder="Telefone:">

            <select name="assunto_servico" required>
        ...
        <textarea name="mensagem_contato" placeholder="Escreva sua mensagem:" required></textarea>
